...
extern void game_set_difficulty(enum difficulty); //難易度を変更する．
extern void game_set_prev_difficulty(enum difficulty); //前の難易度を変更する．
extern enum difficulty game_get_difficulty(void); //難易度を問い合わせる．
extern enum difficulty game_get_prev_difficulty(void); //前の難易度を問い合わせる．
